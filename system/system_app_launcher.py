"""
system/system_app_launcher.py - Native Windows Desktop & System Application Launcher.
...
and launches them directly on the OS with smooth visual System Cursor tracking.
"""
...
def launch_system_application(task: str) -> str:
    """Convenience alias for execute_system_app_launch."""
    return execute_system_app_launch(task)
