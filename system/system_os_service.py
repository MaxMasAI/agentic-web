"""
system/system_os_service.py - System (OS) Command Execution & Subsystem Management.
Provides operating system execution, sys_exec commands, and process execution tools.
"""
